...
\fancyhead[L]{}
\fancyhead[R]{ Bellenote\#1384 \\Version 9.1  \\ \today }
    ...
    \vhEntry{5.2.1}{06.03.2016}{Hairong}{Modified according to Gunar's comments, including grammar, spelling errors and ambiguous descriptions. }
     \vhEntry{5.3}{06.18.2016}{Hairong}{Add tables including all statistical and systematic uncertainties. Modified according to comments from Gunar and Will}
      \vhEntry{5.3.1}{06.23.2016}{Hairong}{Add list of tables, some minor corrects to v5.3}
       ...
       \vhEntry{8.1}{04.12.2018}{Anselm}{Implemented Gunar's comments on version 8.0}        
       \vhEntry{9.0}{05.30.2018}{Gunar}{Many cosmetic changes and streamlining of text/arguments. Some corrections as discussed in bn1384\_ml:0306}   
       \vhEntry{9.1}{07.10.2018}{Gunar}{Change of $A_{12}$ into $R_{12}$ for actual double ratios as discussed on bn1384. Changed all asymmetry labels in Tables~\ref{tab:finalpi0zbin}--\ref{tab:finaletaptbins} to be conform with $A_{12}^{\text{meson choice}}$. Also some minor cosmetic corrections.}   
\end{versionhistory}
...
\include{chapters/section4}

\include{chapters/section5}

\include{chapters/section6}

\include{chapters/section7}
