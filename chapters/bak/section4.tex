...
\begin{figure}[H]
  ...
  \caption{$\pi^0$ double ratio asymmetry $\nicefrac{A^{0\pm}_1}{A^L_1}$ for different kinematic bins. The blue points are original measured asymmetry. Pink points are asymmetries after background correction.}
...
Again, use Eq.~\eqref{eqn:bkgcorr} calculate signal asymmetry $A_{sig}$. Fig.~\ref{fig:etaafterbkg} are results of $\eta$ Collins asymmetry after background correction. 
...
\begin{figure}[H]
  ...
  \caption{$\eta$ double ratio asymmetry $\nicefrac{A^{\eta\pm}_1}{A^L_1}$ for different kinematic bins. The pink points are original measured asymmetry. Blue points are asymmetries after background correction.}
...
\begin{figure}[H]
  ...
  \caption{weighted $\pi^0$ double ratio asymmetry $\nicefrac{A^{0\pm}_{12}}{A^L_{12}}$. Weight on $\pi^0\pi^++\pi^0\pi^-$ is $1+\times P_{t1}P_{t2}$ while $1+0.25\times P_{t1}P_{t2}$ is added on $\pi^+\pi^++\pi^-\pi^- $.}
  \label{fig:weightpi0}
\end{figure}
Fig.~\ref{fig:weightpi0} is an example of re-weighting asymmetries after smearing. The theoretical value $A_{inject}$ is 0.1, however, the double ratios asymmetry $A_{measured}$ obtained are significantly lower than 0.1. The value $\nicefrac{A_{inject}}{A_{measured}}$ represents the thrust smearing factor. 
