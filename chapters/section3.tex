...
\end{figure}
The following Fig.~\ref{fig:exp_pi0_eta_ratio} shows the asymmetries of the ratio between $\pi^0$ and $\eta$ asymmetries. Within the uncertainties, the ratio they are consistent with zero. However, at the highest $z$ and $P_t$ values there is a hint of an excess of $A_{12}^\eta$ over the asymmetries constructed with the neutral pion.
